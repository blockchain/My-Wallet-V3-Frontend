describe('wallet-recovery-page', function() {
    ...
    beforeEach(function() {
        ...
        browser.findElement(by.css('[translate="WALLET_RECOVERY"]')).click();
        browser.findElement(by.css('[translate="WALLET_RECOVERY_EXPLAIN"]'));
