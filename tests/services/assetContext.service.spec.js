  ...
  describe('.getContext()', () => {
    describe('with BTC balance', () => {
      it('should see just btc if does not have ETH', () => {
        ...
        expect(assetContext.getContext().available).toEqual(['btc']);
      });
      ...
      it('should see both if has ETH', () => {
        ...
        expect(assetContext.getContext().available).toEqual(['btc', 'eth']);
      });
    ...
    describe('with ETH balance', () => {
      it('should see just eth if does not have BTC', () => {
        ...
        expect(assetContext.getContext().balance).toEqual('eth');
      });
