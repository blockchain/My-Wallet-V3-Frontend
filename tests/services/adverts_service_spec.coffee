describe "AdvertsServices", () ->
  ...
  describe "fetch()", -> 
    beforeEach ->
      $httpBackend.expectGET("https://blockchain.info/adverts_feed?wallet_version=3").respond sampleAd
