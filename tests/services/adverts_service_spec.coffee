describe "AdvertsServices", () ->
  ...
  describe "fetch()", ->
    beforeEach ->
      ...
      $httpBackend.expectGET("https://api.blockchain.info/ads/get?wallet=true&n=2").respond sampleAd
