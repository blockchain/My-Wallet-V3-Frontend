describe "AdvertsServices", () ->
  ...
  describe "fetch()", ->
    ...
    it "should get the ad title", ->
      expect(Adverts.ads[0].name).toBe "Kraken Deposit"

    it "should get the ad URL", ->
      expect(Adverts.ads[0].url).toContain "http"

    it "should get the image blob", ->
      expect(Adverts.ads[0].data).toContain "data:image"
  ...
  describe "bad ads fetch()", ->
    ...
    it "should not keep bad ads", ->
      expect(Adverts.ads.length).toBe 0
