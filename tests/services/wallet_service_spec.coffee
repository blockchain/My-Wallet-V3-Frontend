describe "walletServices", () ->
  ...
  describe "browser detection", ->
    ...
    beforeEach ->
      ...
      spyOn(Alerts, 'displayWarning').and.callFake(() ->)

    it "should not show an error when above minimum version", ->
      Wallet.checkBrowserVersion()
      expect(Wallet.checkBrowserVersion()).toBe(true)
    ...
    it "should show an error when below minimum version", ->
      ...
      expect(Wallet.checkBrowserVersion()).toBe(false)
    ...
    it "should disallow against old Safari", ->
    ...
    it "should permit modern Webkit", ->
