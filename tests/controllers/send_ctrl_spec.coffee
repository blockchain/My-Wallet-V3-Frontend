describe "SendCtrl", ->
  ...
  it "has a null destination by default", ->
  ...
  describe "transaction", ->
    ...
    describe "destinations", ->
      ...
      it "should add a destination", ->
        expect(scope.transaction.destinations.length).toBe(2)
  ...
  #     scope.transaction.destinations[0] =
  #       address: "1DDBEYPPTkgbctmMtH3gXc7UHFURw5HGJD"
  #     scope.$apply()
