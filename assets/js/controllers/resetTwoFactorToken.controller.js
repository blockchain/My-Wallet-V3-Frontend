...
function ResetTwoFactorTokenCtrl($scope, MyWalletTokenEndpoints, $stateParams, $state, Alerts, $translate, $rootScope) {
  Alerts.clear()
  ...
  MyWalletTokenEndpoints.resetTwoFactor($stateParams.token).then(success).catch(error);
}
