...
function RequestBitcoinCashController ($scope, MyWallet, AngularHelper, BitcoinCash, browser, Env) {
  ...
  $scope.address = (displayOnly) => displayOnly ? BitcoinCash.toBitcoinCash($scope.state.to.receiveAddress) : BitcoinCash.toBitcoinCash($scope.state.to.receiveAddress, true);
